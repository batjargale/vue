        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <button v-show="editmode" type="sumbit" class="btn btn-success">Update</button>
                    <button v-show="!editmode" type="sumbit" class="btn btn-primary">Create</button>
                </div>
                </form>
    ...
    export default {
        ...
        methods: {
            ...
            deleteUser(id){
                ...
                text: "Та устгасан тохиолдолд буцааж сэргээх боломжгүй",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                cancelButtonText: 'Үгүй',
                confirmButtonText: 'Устгахыг зөвшөөрч байна!'
                }).then((result) => {
                    ...
                    this.form.delete('api/user/' +id).then(()=>{
                        swal.fire(
                            'Устгагдлаа!',
                            'Файл амжилттай устгагдлаа.',
                            'success'
                        )
                        Fire.$emit('AfterCreate');
                    }).catch(() =>{
                        swal.fire("Failed!", "Ямар нэг алдаа гарлаа", "warning");
                    });
